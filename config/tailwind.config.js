...
module.exports = {
  ...
  safelist: [
    ...
    "cursor-wait",
    "lg:sr-only",
    // Clases de gradiente y colores para la página de inicio
    {
      pattern: /^(bg-gradient-|from-|via-|to-)/,
    },
    {
      pattern: /^(text-|bg-)(red|gray|blue|green|purple|yellow|indigo|sky)-(50|100|200|300|400|500|600|700|800|900)/,
    },
    "text-red-400",
    "text-gray-300",
    "text-gray-900",
