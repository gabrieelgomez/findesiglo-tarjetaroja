module Spree
  class Address < Spree.base_class
    ...
    ADDRESS_FIELDS = %w(firstname lastname company identifier agency address1 address2 city state zipcode country phone)
    EXCLUDED_KEYS_FOR_COMPARISON = %w(id updated_at created_at deleted_at label user_id public_metadata private_metadata)
    FIELDS_TO_NORMALIZE = %w(firstname lastname phone alternative_phone company identifier agency address1 address2 city zipcode)
    ...
    def set_default_values
      ...
      self.zipcode ||= "2002" # Valor por defecto para zipcode
    end
    ...
    def set_user_attributes
      ...
      user.identifier = user.identifier.presence || identifier.presence
