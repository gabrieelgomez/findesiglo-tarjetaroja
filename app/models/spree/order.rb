...
module Spree
  class Order < Spree.base_class
    ...
    SHIPMENT_STATES = %w(backorder canceled partial pending ready apartado fabricado empacado shipped)
    ...
    self.whitelisted_ransackable_associations = %w[shipments user created_by approver canceler completed_by promotions bill_address ship_address line_items store]
    ...
    belongs_to :completed_by, class_name: "::#{Spree.admin_user_class}", optional: true
