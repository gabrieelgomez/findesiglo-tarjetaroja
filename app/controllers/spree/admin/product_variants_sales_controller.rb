module Spree
  module Admin
    class ProductVariantsSalesController < Spree::Admin::BaseController
      before_action :find_product
      before_action :set_date_range

      def index
        @variants_sales = fetch_variants_sales
      ...
      def fetch_variants_sales
        ...
        Spree::Variant
          ...
          .select(
            ...
            "SUM(spree_line_items.price * spree_line_items.quantity) as total_revenue"
          )
      ...
      def calculate_summary_stats
...

        {
          ...
          total_revenue: line_items.sum('spree_line_items.price * spree_line_items.quantity'),
