...
ActiveRecord::Schema[8.0].define(version: 2026_03_21_120000) do
  ...
  create_table "bcvs", force: :cascade do |t|
    t.float "value"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.float "value_whatsapp"
  end
  ...
  create_table "expense_categories", force: :cascade do |t|
    ...
    t.index ["category_type"], name: "index_expense_categories_on_category_type"
    t.index ["store_id", "name"], name: "index_expense_categories_on_store_id_and_name", unique: true
    t.index ["store_id", "position"], name: "index_expense_categories_on_store_id_and_position"
    t.index ["store_id"], name: "index_expense_categories_on_store_id"
  end
  ...
  create_table "expenses", force: :cascade do |t|
    ...
    t.text "description"
    t.bigint "spree_payment_method_id", null: false
    t.bigint "spree_admin_user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "traspaso", default: false
    t.bigint "store_id", null: false
    t.bigint "expense_category_id"
    t.index ["expense_category_id"], name: "index_expenses_on_expense_category_id"
    t.index ["spree_admin_user_id"], name: "index_expenses_on_spree_admin_user_id"
    t.index ["spree_payment_method_id"], name: "index_expenses_on_spree_payment_method_id"
  ...
  create_table "order_details", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["spree_order_id"], name: "index_order_details_on_spree_order_id"
    t.index ["spree_order_id"], name: "order_details_join_index", unique: true
  end
  ...
  create_table "spree_orders", force: :cascade do |t|
    ...
    t.index ["completed_by_id"], name: "index_spree_orders_on_completed_by_id"
  ...
  create_table "spree_payments", force: :cascade do |t|
    ...
    t.jsonb "private_metadata"
    t.string "referencia"
    t.decimal "monto_bolivares", precision: 10, scale: 2, default: "0.0"
    t.boolean "traspaso", default: false
  ...
  create_table "spree_variant_change_logs", force: :cascade do |t|
    t.bigint "variant_id", null: false
    t.bigint "user_id"
    t.string "action", null: false
    ...
    t.text "old_value"
    t.text "new_value"
    t.string "changed_from_view"
    t.jsonb "metadata", default: {}
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["action"], name: "index_spree_variant_change_logs_on_action"
    t.index ["changed_field"], name: "index_spree_variant_change_logs_on_changed_field"
    t.index ["created_at"], name: "index_spree_variant_change_logs_on_created_at"
    t.index ["user_id"], name: "index_spree_variant_change_logs_on_user_id"
    t.index ["variant_id"], name: "index_spree_variant_change_logs_on_variant_id"
  end
  ...
  create_table "variant_change_logs", force: :cascade do |t|
    ...
    t.string "source", default: "variant_edit", null: false
    t.string "request_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["admin_user_id", "created_at"], name: "index_variant_change_logs_on_admin_user_id_and_created_at"
    t.index ["admin_user_id"], name: "index_variant_change_logs_on_admin_user_id"
    t.index ["created_at"], name: "index_variant_change_logs_on_created_at"
    t.index ["product_id", "created_at"], name: "index_variant_change_logs_on_product_id_and_created_at"
    t.index ["product_id"], name: "index_variant_change_logs_on_product_id"
    t.index ["request_id"], name: "index_variant_change_logs_on_request_id"
    t.index ["variant_id", "created_at"], name: "index_variant_change_logs_on_variant_id_and_created_at"
    t.index ["variant_id"], name: "index_variant_change_logs_on_variant_id"
  end

  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "active_storage_variant_records", "active_storage_blobs", column: "blob_id"
  add_foreign_key "expense_categories", "spree_stores", column: "store_id"
  add_foreign_key "expenses", "expense_categories"
  add_foreign_key "expenses", "spree_admin_users"
  add_foreign_key "expenses", "spree_payment_methods"
  add_foreign_key "expenses", "spree_stores", column: "store_id"
  add_foreign_key "order_details", "spree_orders"
  ...
  add_foreign_key "spree_orders", "spree_admin_users", column: "completed_by_id"
  ...
  add_foreign_key "spree_variant_change_logs", "spree_users", column: "user_id"
  add_foreign_key "spree_variant_change_logs", "spree_variants", column: "variant_id"
  add_foreign_key "variant_change_logs", "spree_admin_users", column: "admin_user_id"
  add_foreign_key "variant_change_logs", "spree_products", column: "product_id"
  add_foreign_key "variant_change_logs", "spree_variants", column: "variant_id"
end
